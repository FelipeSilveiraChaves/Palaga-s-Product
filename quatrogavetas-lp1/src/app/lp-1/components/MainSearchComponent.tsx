...
export default function MainSearchComponent() {
    ...
    const BaseButtonsSearchsStyle =
  "rounded-full text-[21px] h-[45px] px-[18px] inline-flex items-center justify-center leading-none ml-[75px]" +
  "bg-white text-[#1F1F1F] border-[1px] border-[#E5E5E5] " +
    ...
    return (
        <div className="gap-3  flex flex-col items-start">
            ...
            <div className="flex flex-col gap-3 items-start pl-[78px]">
                <div className={`${inter.className} ${BaseButtonsSearchsStyle}`}>
                    Planners
                </div>
                <div className={`${inter.className} ${BaseButtonsSearchsStyle}`}>
                    Hábitos
